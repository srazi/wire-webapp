...
class z.ViewModel.list.ListViewModel
  ...
  constructor: (element_id, @content_view_model, @call_center, @connect_repository, @conversation_repository, @search_repository, @user_repository) ->
    ...
    @conversation_list         = new z.ViewModel.list.ConversationListViewModel 'conversation-list', @, @content_view_model, @call_center, @conversation_repository, @user_repository
    @settings_list             = new z.ViewModel.list.SettingsListViewModel 'settings', @,
    ...
    @actions                   = new z.ViewModel.list.ActionsViewModel 'actions-bubble', @, @conversation_list, @conversation_repository, @user_repository

    @_init_subscriptions()
    #ko.applyBindings @, document.getElementById element_id

  _init_subscriptions: =>
    amplify.subscribe z.event.WebApp.SEARCH.SHOW, => @switch_list z.ViewModel.list.LIST_STATE.START_UI
  ...
  _get_element_id_of_list: (list_state) ->
    switch list_state
      ...
      when z.ViewModel.list.LIST_STATE.SETTINGS then 'settings'
